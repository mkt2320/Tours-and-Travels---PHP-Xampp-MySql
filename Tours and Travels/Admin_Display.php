...
.bg-img {
  /* The image used */
  background-image: url("table.jpg");height:730px;filter: blur(px);-webkit-filter: blur(px);
  width:1519px;
margin:0px;
  height: auto;
...
tr:nth-child(odd) {background-color:#F2DBDE;}
table { background-color: #F2DBDE;  border-collapse: collapse;}
th { background-color:  #2b2d42 ;padding: 15px ;text-align: center;}
...
h1{
  ...
  color: #fff;
  text-align: center;
  text-shadow: 0 0 2px #fff, 0 0 10px #fff, 0 0 10px #0073e6, 0 0 10px #0073e6, 0 0 10px #0073e6, 0 0 10px #0073e6, 0 0 10px #0073e6;
...
<center><h1 style="font-size: 80px;">Packages</h1></center>
